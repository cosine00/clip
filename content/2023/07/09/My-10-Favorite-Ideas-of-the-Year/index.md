...
1-1-1 方法结构简单，时间负担低，是一种开始建立日记练习的简单方法，可在 2023 年下半年改善您的心理健康。
...
过于复杂化和恐吓很容易——我们都知道有人试图这样做。但不要被愚弄了——复杂性和行话常常被用来掩盖缺乏深入理解。
...
根据您的职业和生活限制，您可以扩大或缩小思考日的规模。重点是迫使这种空气和空间进入你的生活并体验它所提供的解锁。
